...
public class RegisterVacation {
    ...
    public void aVacationFromWeekToWeekIsRegisteredForThatUser(String string, String string2) {
        assertTrue(BusinessTests.appBackend.getVacations(BusinessTests.appBackend.findEmployee("Hanne")).get(0).startWeek == Integer.parseInt(string));
        assertTrue(BusinessTests.appBackend.getVacations(BusinessTests.appBackend.findEmployee("Hanne")).get(0).endWeek == Integer.parseInt(string2));
    }
