...
public class RegisterVacation {
    ...
    public void aVacationFromWeekToWeekIsRegisteredForThatUser(String string, String string2) {
        assertTrue(BusinessTests.appBackend.getVacations(BusinessTests.appBackend.findEmployee("hann").id).get(0).getStartWeek() == Integer.parseInt(string));
        assertTrue(BusinessTests.appBackend.getVacations(BusinessTests.appBackend.findEmployee("hann").id).get(0).getEndWeek() == Integer.parseInt(string2));
    }
